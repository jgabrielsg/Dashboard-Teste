...
def graph_goals_per_club(data = goals_data):
    ...
    fig.update_layout(
        title={
            'text': '<b style="color:#222E66;">Gols por Time</b>',
            'y':0.95,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'},
...
def graph_shoots_per_club(data = stats_data):
    ...
    fig.update_layout(
        title={
            'text': '<b style="color:#222E66;">Chutes por Time</b>',
            'y':0.95,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'},
...
def graph_victories_inter(data=results_data):
    ...
    fig.update_layout(
        title={
            'text': '<b style="color:#222E66;">Vitórias por Time</b>',
            'y':0.95,
            'x':0.5,
            'xanchor': 'center',
            'yanchor': 'top'},
...
def graph_cards_per_team(data=cards_data):
    ...
    fig.update_layout(
        title={
            'text': '<b style="color:#222E66;">Cartões por Time</b>',
            'y': 0.95,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top'
...
def graph_best_goal_scorers(data=goals_data):
    ...
    fig.update_layout(
        title={
            'text': '<b style="color:#222E66;">Os Artilheiros</b>',
            'y': 0.95,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top'
...
def graph_results_per_team(time="Internacional"):
    ...
    # Contar o número de vitórias, empates e derrotas EM CASA MANÈ
    ...
    # Contar o número de vitórias, empates e derrotas FORA DE CASA MANÈ
...
def graph_goals_per_team(time="Internacional"):
    ...
    fig.update_layout(
        title={
            'text': f'<b style="color:#222E66;">Gols Marcados e Sofridos por Time ({time})</b>',
            'y': 0.95,
            'x': 0.5,
            'xanchor': 'center',
            'yanchor': 'top'
